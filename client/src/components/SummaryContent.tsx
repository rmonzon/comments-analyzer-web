    ...
    <div className="animate-fade-in">
      ...
      <div className="animate-fade-in animation-delay-500">
        ...
        <div className="mt-4 text-sm text-gray-500 dark:text-gray-400 italic animate-fade-in" style={{ animationDelay: '1000ms' }}>
          <p>Summary generated by AI based on {analysis.commentsAnalyzed} viewer comments (limited to 40). Video creator's comments are excluded to focus on audience feedback. Results may not represent all opinions. <span className="text-purple-500 dark:text-purple-400 cursor-pointer hover:underline" onClick={() => document.getElementById('premium-interest-trigger')?.click()}>Want to analyze more comments? Express your interest in our premium features.</span></p>
        </div>
      </div>
    </div>
  );

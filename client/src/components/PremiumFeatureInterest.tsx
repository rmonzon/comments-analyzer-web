  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Thanks for your interest in premium features. We'll notify you when they become available.",
      });
          ...
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-sm mb-3">
                Currently limited to 20 comments per analysis. Help us gauge interest in analyzing 100+ comments for deeper insights.
              </p>
              ...
              <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                ...
                <DialogContent className="sm:max-w-[425px]">
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Help us understand the demand for deeper comment analysis by expressing your interest.
                    </DialogDescription>
                  </DialogHeader>
                  ...
                  {!isSubmitted ? (
                    ...
                    <div className="py-8 flex flex-col items-center text-center">
                      ...
                      <p className="text-gray-600 dark:text-gray-300 text-sm">
                        We'll notify you at <span className="font-medium">{email}</span> when premium features become available.
                      </p>
                    </div>
                  )}
                </DialogContent>

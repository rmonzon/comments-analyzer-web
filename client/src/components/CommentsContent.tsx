    ...
    <div className="p-6 animate-fade-in">
      <div className="flex justify-between items-center mb-4">
        ...
        <div className="relative">
          ...
          <span className="absolute right-3 top-1/2 transform -translate-y-1/2">
            <span className="material-icons text-youtube-dark-grey">arrow_drop_down</span>
          </span>
        </div>
      </div>
      ...
      <div className="space-y-4 max-h-96 overflow-y-auto pr-2">
        {sortedComments.slice(0, visibleComments).map((comment) => (
          <div key={comment.id} className="border-b border-youtube-border pb-4 last:border-b-0 last:pb-0">
              ...
              <div className="w-10 h-10 rounded-full bg-gray-300 mr-3 overflow-hidden">
                {comment.authorProfileImageUrl ? (
                  ...
                  <div className="w-full h-full flex items-center justify-center bg-youtube-light-grey">
                    <span className="material-icons text-youtube-dark-grey">person</span>
                  </div>
                )}
              </div>
              <div className="flex-1">
                <div className="flex items-center mb-1">
                  <p className="font-medium mr-2">{comment.authorDisplayName}</p>
                ...
                <div className="flex items-center text-sm text-youtube-dark-grey">
                  <div className="flex items-center mr-4">
                    <span className="material-icons text-base mr-1">thumb_up</span>

    ...
    <div className="container max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="space-y-6 text-gray-700 dark:text-gray-300">
        <section>
          ...
          <p>
            Welcome to YouTube Comment Analyzer. These terms of service govern
        ...
        <section>
          ...
          <p>
            By accessing or using YouTube Comment Analyzer, you agree to be
        ...
        <section>
          ...
          <p>
            YouTube Comment Analyzer provides AI-powered analysis of YouTube
            video comments to generate insights, summaries, and sentiment
            analysis. This service is provided "as is" with no guarantees
            regarding accuracy, completeness, or reliability of the analyses
            provided.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            are and will remain the exclusive property of YouTube Comment
            Analyzer and its licensors. The service is protected by copyright,
            trademark, and other laws. Our trademarks and trade dress may not be
        ...
        <section>
          ...
          <p>
            ...
            submit to the site, including YouTube video URLs you input for
            analysis, are your sole responsibility. We do not claim ownership of
            your content, but you grant us a license to use, store, and display
            your content for the purpose of providing our service to you.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            accuracy, completeness, or usefulness of any analyses or information
        ...
        <section>
          ...
          <p>
            ...
            contact us at:{" "}
            <a
              href="mailto:terms@commentsanalyzer.info"
              className="text-blue-600 dark:text-blue-400"
            >
              terms@commentsanalyzer.info
            </a>
          </p>
        </section>
      </div>
